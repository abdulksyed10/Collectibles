...
export type Collection = { id: string; owner_id: string; category_id: string; name: string; description: string; created_at: string };
...
export type CollectionDraft = { name: string; description: string; categoryId: string };
...
export interface CollectionRepository {
  ...
  listItems(options: { categoryId?: string; collectionId?: string; search: string; page: number }): Promise<ItemPage>;
